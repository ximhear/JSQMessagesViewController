...
- (void)jsq_configureCollectionView
{
    ...
    [self registerNib:[JSQMessagesCollectionViewCellOutgoingSystem nib] forCellWithReuseIdentifier:[JSQMessagesCollectionViewCellOutgoingSystem cellReuseIdentifier]];
